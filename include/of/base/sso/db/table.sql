...
('_of_sso_realm','InnoDB','Compact','utf8_general_ci','2','','单点登录域名表'),
...
('_of_sso_func','realmId','2',NULL,'NO',NULL,NULL,'int(10) unsigned','','域名ID,关联_of_sso_realm::id'),
...
('_of_sso_pack','realmId','2',NULL,'NO',NULL,NULL,'int(10) unsigned','','域名ID,关联_of_sso_realm::id'),
...
('_of_sso_permit','realmId','2','0','NO',NULL,NULL,'int(10) unsigned','','域名ID,关联_of_sso_realm::id'),
...
('_of_sso_realm','trust','7','0','NO',NULL,NULL,'tinyint(1)','','域名对接权限,1=可操作当前用户和域名的数据,3=还可通过帐号密码操作用户域名,7=还可获取用户列表并无限制操作用户'),
('_of_sso_role','id','1',NULL,'NO',NULL,NULL,'int(10) unsigned','auto_increment','主键'),
('_of_sso_role','realmId','2','0','NO',NULL,NULL,'int(10) unsigned','','域名ID,关联_of_sso_realm::id'),
...
('_of_sso_func','0','通过域名ID和权限名查找权限数据','`realmId`,`name`','BTREE'),
...
('_of_sso_pack','0','通过域名ID和包名查找包数据','`realmId`,`name`','BTREE'),
...
('_of_sso_permit','0','通过域名ID用户ID包ID查询关联数据','`realmId`,`userId`,`packId`','BTREE'),
('_of_sso_realm','0','PRIMARY','`id`','BTREE'),
('_of_sso_realm','0','根据帐号查询域名信息','`name`','BTREE'),
