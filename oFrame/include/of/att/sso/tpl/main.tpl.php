    ...
    <tfoot>
        <tr class="of_sso-main_tfoot_func">
            ...
            <td colspan="3">
                ...
                <a class="of_sso-main_tfoot_func_add" onclick="ofBaseSsoMain.edit(true, 'realm'); return false;">&nbsp;</a>
                <a class="of_sso-main_tfoot_func_del" onclick="ofBaseSsoMain.action('realm', 'del'); return false;">&nbsp;</a>
                <a class="of_sso-main_tfoot_func_ice" onclick="ofBaseSsoMain.action('realm', 'ice'); return false;">&nbsp;</a>
            </td>
            <td colspan="3">
                ...
                <a class="of_sso-main_tfoot_func_add" onclick="ofBaseSsoMain.edit(true, 'pack'); return false;">&nbsp;</a>
                <a class="of_sso-main_tfoot_func_del" onclick="ofBaseSsoMain.action('pack', 'del'); return false;">&nbsp;</a>
                <a class="of_sso-main_tfoot_func_ice" onclick="ofBaseSsoMain.action('pack', 'ice'); return false;">&nbsp;</a>
            </td>
            <td colspan="3">
